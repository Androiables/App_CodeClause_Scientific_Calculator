...
public class EvaluatorUnitTest {
    ...
    public void addition_isCorrect() {
        assertEquals("4", Evaluator.solve("2 + 2"));
    }

    @Test
    public void subtraction_isCorrect() {
        assertEquals("4", Evaluator.solve("6 - 2"));
    }

    @Test
    public void product1_isCorrect() {
        assertEquals("4", Evaluator.solve("2 x 2"));
    }
    ...
    public void division_isCorrect() {
        assertEquals("3", Evaluator.solve("6 / 2"));
    }

    @Test
    public void divisionByZero_isCorrect() {
        assertEquals("Infinity", Evaluator.solve("6 / 0"));
    }

    @Test
    public void divisionZeroByZero_isCorrect() {
        assertEquals("NaN", Evaluator.solve("0 / 0"));
    }
    ...
    public void generalExpression_isCorrect() {
        assertEquals("-12", Evaluator.solve("2 + 1 - 5 * 6 / 2 ^ 1"));
    }

    @Test
    public void bracesExpression_isCorrect() {
        assertEquals("6", Evaluator.solve("( 2 + 1 ) * 2"));
    }

    @Test
    public void doubleExpression_isCorrect() {
        assertEquals("3.5", Evaluator.solve("( ( 2.5 + 3.5 ) + 1.0 ) / 2.0"));
    }

    @Test
    public void inverseExpression_isCorrect() {
        assertEquals("0.2", Evaluator.solve("2^-1"));
    }
}